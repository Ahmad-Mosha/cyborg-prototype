...
export default function AuthScreen() {
  ...
  const leftTextStyle = useAnimatedStyle(() => {
    return {
      opacity: switchAnim.value === 0 ? 1 : 0.6,
    };
  });

  const rightTextStyle = useAnimatedStyle(() => {
    return {
      opacity: switchAnim.value === 1 ? 1 : 0.6,
    };
  });
      ...
      >
        <View className="flex-1 px-6 justify-center items-center">
          ...
          >
            ...
            {/* Email Input */}
            <Animated.View
              entering={SlideInUp.delay(isLogin ? 400 : 600).springify()}
              className="flex-row items-center px-4 py-3 mb-4 rounded-full border border-dark-800 bg-dark-800"
            >
              <Ionicons
                name="mail-outline"
            ...
            {/* Password Input */}
            <Animated.View
              entering={SlideInUp.delay(isLogin ? 500 : 700).springify()}
            ...
            <Animated.View entering={FadeInUp.delay(isLogin ? 600 : 800)}>
            ...
            <Animated.View
              entering={SlideInUp.delay(isLogin ? 700 : 900).springify()}
            >
              <TouchableOpacity
