...
export default function WorkoutScreen() {
  ...
  const workoutPlans = [
    {
      ...
      image: 'https://via.placeholder.com/600/121212/BBFD00?text=30+Day+Strength',
      duration: '30 days',
      workouts: 24,
      category: 'strength',
    },
    {
      ...
      image: 'https://via.placeholder.com/600/121212/BBFD00?text=HIIT+Fat+Burner',
      duration: '14 days',
      workouts: 12,
      category: 'hiit',
    },
  ...
  const WorkoutCard = ({ workout }) => {
    return (
      <TouchableOpacity 
        className="mr-4 w-64 rounded-3xl overflow-hidden bg-dark-800 border border-dark-700"
      >
        <Image 
        ...
        <View className="p-3">
          ...
          <View className="flex-row justify-between mb-2">
            ...
            <View className="flex-row items-center">
              ...
              <Text className="text-gray-400 ml-1">{workout.calories} kcal</Text>
            </View>
          </View>
    ...
    return (
      ...
      >
        ...
        <View className="p-3">
          ...
          <Text className="text-gray-400 text-sm mb-2" numberOfLines={2}>{plan.description}</Text>
          ...
          <View className="flex-row justify-between">
            ...
            <View className="flex-row items-center">
              ...
              <Text className="text-gray-400 ml-1">{plan.workouts} workouts</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
  ...
  const ExerciseItem = ({ name, sets, reps, rest }) => {
    return (
      ...
      >
        <ScrollView showsVerticalScrollIndicator={false}>
          <View className="p-6">
            ...
            <Text className="text-white text-2xl font-bold mb-1">{featuredWorkout.title}</Text>
            <Text className="text-gray-400 mb-4">with {featuredWorkout.coach}</Text>
            ...
            <View className="flex-row justify-between mb-6">
              <View className="items-center">
                ...
                <Text className="text-white font-bold">{featuredWorkout.duration}</Text>
              ...
              <View className="items-center">
                ...
                <Text className="text-white font-bold">{featuredWorkout.calories}</Text>
              ...
              <View className="items-center">
                ...
                <Text className="text-white font-bold">{featuredWorkout.level}</Text>
            ...
            {[
              ...
              { name: 'Incline Dumbbell Press', sets: 3, reps: '12-15', rest: 45 },
            ...
            <TouchableOpacity className="bg-primary py-4 rounded-full mt-6">
              <Text className="text-dark-900 font-bold text-center text-lg">Start Workout</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </Animated.View>
      ...
      >
          ...
          {categories.map(category => (
            <TouchableOpacity
              ...
              className={`mr-3 px-4 py-2 rounded-full ${
                selectedCategory === category.id ? 'bg-primary' : 'bg-dark-800 border border-dark-700'
              }`}
            >
              <Text 
                className={
                  selectedCategory === category.id ? 'text-dark-900 font-bold' : 'text-white'
                }
              >
                {category.name}
              </Text>
        ...
        >
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-white text-lg font-bold">Featured Workout</Text>
          </View>
          
          <TouchableOpacity 
            className="bg-dark-800 rounded-3xl overflow-hidden border border-dark-700"
          >
            <Image 
              source={{ uri: featuredWorkout.image }}
            ...
            <View className="p-4">
              <View className="flex-row justify-between items-center mb-2">
                <Text className="text-white font-bold text-xl">{featuredWorkout.title}</Text>
                <View className="bg-primary/20 px-3 py-1 rounded-full">
                  <Text className="text-primary font-bold">{featuredWorkout.level}</Text>
                </View>
              </View>
              
              <View className="flex-row justify-between mb-4">
                <View className="flex-row items-center">
                  <Ionicons name="person-circle-outline" size={18} color="#A0A0A0" />
                  <Text className="text-gray-400 ml-1">with {featuredWorkout.coach}</Text>
                </View>
                
                <View className="flex-row">
                  <View className="flex-row items-center mr-3">
                    <Ionicons name="time-outline" size={16} color="#A0A0A0" />
                    <Text className="text-gray-400 ml-1">{featuredWorkout.duration}</Text>
                  </View>
                  
                  <View className="flex-row items-center">
                    <Ionicons name="flame-outline" size={16} color="#A0A0A0" />
                    <Text className="text-gray-400 ml-1">{featuredWorkout.calories} kcal</Text>
                  </View>
                </View>
              </View>
              ...
              <TouchableOpacity className="bg-primary py-3 rounded-full flex-row items-center justify-center">
                ...
                <Text className="text-dark-900 font-bold ml-2">Start Workout</Text>
              </TouchableOpacity>
            </View>
          </TouchableOpacity>
        </Animated.View>
