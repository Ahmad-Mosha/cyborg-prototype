      ...
      >
          ...
          <>
            ...
            >
              <View className="bg-dark-800 rounded-3xl border border-dark-700 p-5">
                <Text className="text-gray-300 mb-3">Daily Nutrition Goals</Text>
                ...
                <View className="w-full h-[6px] bg-dark-700 rounded-full flex-row overflow-hidden">
                  ...
                  <View className="h-full bg-[#FF9800]" style={{ width: '25%' }} />
                  <View className="h-full bg-[#2196F3]" style={{ width: '10%' }} />
                </View>
              </View>
            </Animated.View>
                ...
                >
                  <View className="flex-row justify-between items-center mb-2">
                    <View className="flex-row items-center">
                      ...
                      >
                        <Ionicons 
                          name={meal.complete ? "checkmark-circle" : "time-outline"} 
                          size={20} 
                          color={meal.color}
                        />
                      </View>
                      <View>
                        <Text className="text-gray-400 text-sm">{meal.time}</Text>
                        <Text className="text-white font-bold text-base">{meal.title}</Text>
                      </View>
                    </View>
                    
                    <View>
                      <Text className="text-white font-bold text-right">{meal.calories} <Text className="text-gray-400 font-normal">kcal</Text></Text>
                    </View>
                  </View>
                  
                  <Text className="text-gray-400 ml-13" numberOfLines={1}>{meal.items}</Text>
        ...
        {activeTab === 'nutrition' && (
          <View className="px-6 items-center justify-center">
            <Text className="text-white text-lg">Nutrition tracking coming soon</Text>
          </View>
        )}
        
        {activeTab === 'water' && (
          <View className="px-6 items-center justify-center">
            <Text className="text-white text-lg">Water tracking coming soon</Text>
          </View>
        )}
        
        {activeTab === 'supplements' && (
          <View className="px-6 items-center justify-center">
            <Text className="text-white text-lg">Supplements tracking coming soon</Text>
          </View>
        )}
      </ScrollView>
    </View>
